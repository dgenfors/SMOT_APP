...
export default function Main(props) {
  ...
  function DetailsNavigator({ route }) {
    return (<Tab.Navigator>
      <Tab.Screen name="Details" options={{ lazy:true, unmountOnBlur: true  }} children={() => <DetailsPage userData={route.params}  />} />
      <Tab.Screen name="Add Plant" component={searchbarPresenter} options={{ lazy:true, unmountOnBlur: true }}/>
      <Tab.Screen name="History" options={{lazy:true, unmountOnBlur: true }} children={() => <HistoryPage userData={route.params} />} />
    </Tab.Navigator>);
  }
  function LoginTab() {
